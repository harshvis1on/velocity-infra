...
export function TemplateShowcase() {
  ...
  return (
    <div className="bg-[#0a0a0a] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
      <div className="flex flex-wrap border-b border-white/10 bg-black/50">
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-black border border-white/10 rounded-lg p-4">
            <div className="text-xs text-gray-500 mb-1 uppercase tracking-wider">Docker Template</div>
            <div className="font-mono text-sm text-green-400 truncate">{activeTab.dockerImage}</div>
          </div>
          <div className="bg-black border border-white/10 rounded-lg p-4">
            <div className="text-xs text-gray-500 mb-1 uppercase tracking-wider">Expected Boot Time</div>
            <div className="font-mono text-sm text-white">{activeTab.bootTime}</div>
          </div>
          <div className="bg-black border border-white/10 rounded-lg p-4">
            <div className="text-xs text-gray-500 mb-1 uppercase tracking-wider">Starting Price</div>
            <div className="font-mono text-sm text-primary font-bold">{activeTab.startPrice}</div>
          </div>
        </div>

        <Link
          href="/signup"
          className="w-full bg-primary hover:bg-primary-dark text-black font-bold py-3 px-8 rounded-lg transition-all flex items-center justify-center gap-2"
        >
