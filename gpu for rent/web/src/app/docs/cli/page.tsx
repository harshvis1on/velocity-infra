  ...
  return (
    <article className="space-y-12 text-[#E2E8F0]">
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-bold font-heading tracking-tight text-white md:text-4xl">CLI Reference</h1>
        <div className="flex flex-wrap items-center gap-2">
          <StatusBadge kind="live" />
          <span className="text-lg leading-relaxed text-[#94A3B8]">
            Node.js Commander app <code className="text-primary/95 font-mono">velocity</code> (v3.0.0), entry
            at <code className="text-primary/95 font-mono">/cli/index.js</code>.
          </span>
        </div>
      </header>
...
cd cli && npm link`}
        ...
        <InfoBox>
          <p>
            ...
            <code className="rounded bg-[#080D16] px-1 font-mono text-[13px] text-primary/95">
              npm link
            </code>{' '}
...
# Stores in ~/.velocity/credentials.json`}
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold font-heading text-white">Renter commands</h2>
        <DocTable
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold font-heading text-white">Host commands</h2>
        <DocTable
          headers={['Command', 'Description', 'Status']}
          rows={[
      ...
      <section className="space-y-4">
        ...
        <WarningBox title="Roadmap gaps">
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <code className="text-primary/95 font-mono">velocity stop &lt;id&gt;</code> /{' '}
              <code className="text-primary/95 font-mono">velocity destroy &lt;id&gt;</code> — not in CLI yet
              (web console only).
            </li>
            <li>
              <code className="text-primary/95 font-mono">velocity logs &lt;id&gt;</code> — no log streaming.
            </li>
            <li>
              <code className="text-primary/95 font-mono">velocity scp</code> — no file transfer command.
            </li>
            <li>
              <code className="text-primary/95 font-mono">velocity run &lt;script&gt;</code> — no managed
              runs yet.
            </li>
