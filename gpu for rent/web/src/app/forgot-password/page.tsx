          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 anim-fadeUp anim-delay-2">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-gray-400 uppercase tracking-wider" htmlFor="email">Email Address</label>
                <input
              ...
              <Link href="/login" className="text-sm text-gray-500 hover:text-primary transition-colors text-center mt-2">
                ← Back to Sign In
              </Link>
            </form>
          )}
