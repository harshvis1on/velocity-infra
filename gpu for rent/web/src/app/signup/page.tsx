        ...
        <div className="relative z-10 anim-fadeUp anim-delay-4">
          <div className="flex items-center gap-4 text-xs text-gray-600">
            <div className="flex -space-x-2">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="w-6 h-6 rounded-full bg-white/10 border-2 border-[#060606]" />
              ))}
            </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 lg:border-l lg:border-white/[0.06] relative">
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-8 anim-fadeUp anim-delay-1">
            ...
            <p className="text-gray-500 text-sm">Free GPU credits on signup. No card required.</p>
          </div>

          {refCode && (
            <div className="mb-5 p-3 bg-yellow-400/5 border border-yellow-400/10 rounded-lg flex items-center gap-2.5 anim-fadeUp">
          ...
          {message && (
            <div className="mb-5 p-3 bg-primary/10 border border-primary/20 text-primary text-sm rounded-lg anim-fadeUp">
              {message}
            </div>
          )}
