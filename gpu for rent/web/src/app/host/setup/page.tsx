      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {currentStep === 1 && (
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm">Make sure your machine has the following before we install the agent.</p>
            <div className="grid gap-3">
              {[
                ...
                <div key={req.name} className="flex items-start gap-3 p-4 bg-white/5 border border-white/10 rounded-lg">
            ...
            <button
              ...
              className="bg-primary hover:bg-primary-dark text-black font-bold py-2.5 px-6 rounded-lg transition-colors"
            >
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm">This key lets your machine talk to our API. It's only shown once, so save it somewhere safe.</p>
            ...
            {apiKey ? (
              <div className="p-4 bg-primary/10 border border-primary/20 rounded-lg">
                ...
                <div className="flex items-center gap-2">
                  <code className="text-sm font-mono bg-black/50 px-3 py-1.5 rounded flex-1 break-all text-white">{apiKey}</code>
                  <button
              ...
              <div className="flex gap-3 items-end">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg px-3 py-2 bg-black/50 border border-white/10 text-sm focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none"
                  />
                </div>
                <button
                  onClick={generateApiKey}
                  disabled={creatingKey || !isAuthenticated}
                  className="bg-primary hover:bg-primary-dark text-black font-bold py-2 px-6 rounded-lg transition-colors disabled:opacity-50 whitespace-nowrap"
                >
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm">Paste this into your machine's terminal. It downloads the agent, registers your machine, and starts the background service.</p>
            ...
            <div className="bg-[#0a0a0a] border border-white/10 rounded-xl p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs text-gray-500 font-mono">bash{testMode ? ' (test mode)' : ''}</span>
                <button
            ...
            <div className="text-sm text-gray-400">
              ...
              <ol className="list-decimal list-inside space-y-1 text-gray-500">
                ...
                <li>Download the agent to <code className="text-gray-400">/opt/velocity/</code></li>
        ...
        {currentStep === 4 && (
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm">We're listening for the first heartbeat from your agent. This usually takes under a minute.</p>
              ...
              {recentMachine ? (
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-green-400">Machine Connected!</div>
                      <div className="text-xs text-gray-400 font-mono">ID: {recentMachine.id.substring(0, 12)}</div>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div className="bg-black/30 rounded-lg p-3 border border-white/5">
                      <div className="text-xs text-gray-500">Self-Test</div>
                      <div className={`font-medium ${recentMachine.self_test_passed ? 'text-green-400' : 'text-yellow-400'}`}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Polling every 5 seconds. Make sure the install script completed successfully.</div>
                  </div>
                </div>
              )}
            </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm">Your machine is online. Head to the dashboard to set pricing and start earning.</p>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">Your machine is online and ready to accept workloads.</div>
                </div>
              </div>
              ...
              <div className="text-sm text-gray-400 space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-500">
                  <li>Create an <span className="text-white">Offer</span> with your per-GPU hourly rate</li>
            ...
            <div className="flex gap-4">
              <Link
                href="/host/dashboard"
                className="bg-primary hover:bg-primary-dark text-black font-bold py-2.5 px-6 rounded-lg transition-colors inline-block"
              >
                Go to Host Dashboard
              </Link>
              <Link
                href="/settings"
                className="bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium py-2.5 px-6 rounded-lg transition-colors inline-block"
              >
                Manage API Keys
              </Link>
            </div>
