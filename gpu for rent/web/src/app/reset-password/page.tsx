      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 lg:border-l lg:border-white/[0.06]">
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-8 anim-fadeUp anim-delay-1">
            <h2 className="text-2xl font-bold text-white mb-1 font-heading">Pick a new password</h2>
            <p className="text-[#64748B] text-sm">Choose something strong. At least 8 characters.</p>
          </div>
          ...
          {!ready ? (
            <div className="text-center py-8 anim-fadeUp anim-delay-2">
              ...
              <p className="text-sm text-[#64748B] mb-4">Verifying reset token...</p>
              <Link href="/forgot-password" className="text-xs text-[#475569] hover:text-primary transition-colors">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 anim-fadeUp anim-delay-2">
              <div className="flex flex-col gap-1.5">
                <label className="text-[11px] font-semibold text-[#475569] uppercase tracking-wider" htmlFor="password">New Password</label>
                <input
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[11px] font-semibold text-[#475569] uppercase tracking-wider" htmlFor="confirmPassword">Confirm Password</label>
                <input
                  className="rounded-xl px-4 py-2.5 bg-white/[0.03] border border-white/[0.08] focus:border-primary/50 focus:shadow-[0_0_0_3px_rgba(99,102,241,0.1)] focus:outline-none transition-all placeholder:text-[#475569] text-white"
                  type="password"
