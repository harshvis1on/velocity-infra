    ...
    <div className="min-h-[100dvh] flex bg-[#060606]">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[50%] relative flex-col justify-between p-12 xl:p-16 overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-lg">
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-10 anim-fadeUp anim-delay-2">
          ...
          <div className="flex gap-8 anim-fadeUp anim-delay-3">
            <div>
              ...
              <div className="text-xs text-gray-500 mt-1">GPUs available</div>
            </div>
            <div className="w-px bg-white/10" />
            <div>
              <div className="text-2xl font-bold text-white">80%</div>
              <div className="text-xs text-gray-500 mt-1">cheaper than AWS</div>
            </div>
            <div className="w-px bg-white/10" />
            <div>
              <div className="text-2xl font-bold text-white">&lt;30s</div>
              <div className="text-xs text-gray-500 mt-1">deploy time</div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 lg:border-l lg:border-white/[0.06] relative">
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-8 anim-fadeUp anim-delay-1">
            ...
            <p className="text-gray-500 text-sm">Sign in to access your GPUs.</p>
          </div>

          {errorMsg && (
            <div className="mb-6 p-3 bg-red-500/10 border border-red-500/20 text-red-400 text-sm rounded-lg anim-fadeUp">
              {errorMsg}
            </div>
          )}

          {message && (
            <div className="mb-6 p-3 bg-primary/10 border border-primary/20 text-primary text-sm rounded-lg anim-fadeUp">
              {message}
            </div>
          )}
          ...
          <div className="flex flex-col gap-3 mb-6 anim-fadeUp anim-delay-2">
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-white font-medium py-2.5 px-4 rounded-lg transition-all disabled:opacity-50"
            >
          ...
          <form onSubmit={signInWithPassword} className="flex flex-col gap-4 anim-fadeUp anim-delay-3">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-400 uppercase tracking-wider" htmlFor="email">Email</label>
              <input
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                <label className="text-xs font-medium text-gray-400 uppercase tracking-wider" htmlFor="password">Password</label>
                <Link href="/forgot-password" className="text-xs text-gray-500 hover:text-primary transition-colors">Forgot?</Link>
              </div>
              <input
                className="rounded-lg px-4 py-2.5 bg-white/[0.03] border border-white/[0.08] focus:border-primary/50 focus:ring-1 focus:ring-primary/20 focus:outline-none transition-all placeholder:text-gray-700 text-white"
                type="password"
            ...
            <div className="flex flex-col gap-2.5 mt-2">
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-primary hover:bg-primary/90 text-black font-bold rounded-lg px-4 py-2.5 transition-all disabled:opacity-50 active:scale-[0.98]"
              >
              ...
              <button
                ...
                className="w-full bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-gray-300 font-medium rounded-lg px-4 py-2.5 transition-all text-sm disabled:opacity-50"
              >
                Send Magic Link
              </button>
            </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-500 anim-fadeUp anim-delay-4">
          ...
          <div className="mt-10 flex items-center justify-center gap-6 text-[11px] text-gray-600 anim-fadeUp anim-delay-5">
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="flex-1 flex items-center justify-center min-h-[100dvh] bg-[#060606]">
